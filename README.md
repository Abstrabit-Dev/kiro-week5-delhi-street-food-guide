...
```
kiro-week5-delhi-street-food-guide/
│
├── .kiro/
│   ├── agents/
...
```bash
git clone https://github.com/yourusername/kiro-week5-delhi-street-food-guide.git
cd kiro-week5-delhi-street-food-guide
```
...
4. Run the agent:
```bash
cd /{your_repository_path}/kiro-week5-delhi-street-food-guide && streamlit run app.py

Alternatively if you want to run on CLI then run below command:
kiro-cli chat --agent kiro-week5-delhi-street-food-guide
```
